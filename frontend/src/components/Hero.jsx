...
const Hero = () => {
    return (
        <div className='flex flex-col  md:flex-row h-[83vh] md:h-[50vh] gap-20 md:gap-0 relative rounded-md mt-4 w-full bg-[#5f6fff] ' >
            {/* ---------------------left------------------------ */}
            <div className='w-full  pt-6 md:justify-center  text-center md:text-start md:pl-16 flex flex-col md:w-1/2  h-full '   >
                ...
                <button className=' md:mx-0 transition-all duration-200 hover:scale-105 flex mx-auto mt-4 w-fit  items-center gap-2 bg-white rounded-full py-3 px-6 cursor-pointer '  >Book appointment <span><img src={assets.arrow_icon} alt="" /></span> </button>
            </div>
            {/* ---------------------right------------------------- */}
